        ...
        <div className='homecopy'>
          <div className='container grid-2 py-3 mx-3'>
            <div className='card' style={{ height: "500px" }}>
              ...
              <i>
                Thank you for Responding to our Email. We are looking forward to
                helping you resolve your grievance with the tax company, and
                then help you solve your tax problems.{" "}
              </i>
